...
void ScreenEndingState::DrawScreen(void)
{
	...
	if (GameInst.GetLives()<0) DrawTextEx(font, "GAME OVER", Vector2{ (GetScreenWidth() / 2.f) - 150, (GetScreenHeight() / 2.f) -150 }, 40, 1, RED);
	else DrawTextEx(font, "YOU WIN!", Vector2{ (GetScreenWidth() / 2.f) - 150, (GetScreenHeight() / 2.f) - 150 }, 40, 1, WHITE);
